    ...
    <body>
        ...
        <div class= "Profile">
          ...
          <div id = "requests_id" style="display: none">
           ...
           <p><button type = "button" value = "delete" onclick= show("delete_id")>delete account</button></p>
          ...
          <p> <button type = "button" value = "popular quizzes" onclick= show("popular_id")>popular quizzes</button></p>
          ...
          <p> <button type = "button" value = "recently quizzes" onclick= show("recently_id")>recently created quizzes</button></p>
          ...
          <p> <button type = "button" value = "recently taken quizzes" onclick= show("recentlyTaken_id")>recently taken quizzes</button></p>
