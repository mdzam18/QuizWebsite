 ...
 * Generated at: 2020-08-10 19:12:26 UTC
...
public final class UserPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        if(id == \"request_div\") {\r\n");
      out.write("            $(\"#FriendRequesting_output\").html(\"\");\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      ...
      out.write("        $(\"#FriendRequesting_button\").on(\"click\", function () {\r\n");
      out.write("            let username = $(\"#FriendRequesting_username\").val();\r\n");
      out.write("            let button = $(\"#FriendRequesting_button\").val();\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                data: {\r\n");
      ...
      out.write("                    const success = \"successfully\";\r\n");
      out.write("                    let output = $(\"#FriendRequesting_output\");\r\n");
      out.write("                    if(res.includes(success)) {\r\n");
      out.write("                        output.css(\"color\", \"green\");\r\n");
      out.write("                    } else {\r\n");
      out.write("                        output.css(\"color\", \"red\");\r\n");
      out.write("                    }\r\n");
      out.write("                    output.html(res);\r\n");
      out.write("                    //alert(res);\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        })\r\n");
      out.write("        $(\"#Composing_button\").on(\"click\", function () {\r\n");
      out.write("            let username = $(\"#Composing_username\").val();\r\n");
      out.write("            let message = $(\"#Composing_message\").val();\r\n");
      out.write("            let button = $(\"#Composing_button\").val();\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                data: {\r\n");
      out.write("                    username: username,\r\n");
      ...
      out.write("                success: function (res) {\r\n");
      out.write("                    const success = \"successfully\";\r\n");
      out.write("                    let output = $(\"#Composing_output\");\r\n");
      out.write("                    if(res.includes(success)) {\r\n");
      out.write("                        output.css(\"color\", \"green\");\r\n");
      out.write("                    } else {\r\n");
      out.write("                        output.css(\"color\", \"red\");\r\n");
      ...
      out.write("            });\r\n");
      out.write("        })\r\n");
      out.write("        $(\"#Challenging_button\").on(\"click\", function () {\r\n");
      out.write("            let username = $(\"#Challenging_username\").val();\r\n");
      out.write("            let quizzes = $(\"#Challenging_quizzes\").val();\r\n");
      out.write("            let button = $(\"#Challenging_button\").val();\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                data: {\r\n");
      out.write("                    username: username,\r\n");
      ...
      out.write("                success: function (res) {\r\n");
      out.write("                    const success = \"successfully\";\r\n");
      out.write("                    let output = $(\"#Challenging_output\");\r\n");
      out.write("                    if(res.includes(success)) {\r\n");
      out.write("                        output.css(\"color\", \"green\");\r\n");
      out.write("                    } else {\r\n");
      out.write("                        output.css(\"color\", \"red\");\r\n");
    ...
    ArrayList<Mail> mails = mailDao.getMails(id);
      ...
      out.write("    }\r\n");
      out.write("    .admin a:link {\r\n");
      out.write("        text-decoration: none;\r\n");
      out.write("    }\r\n");
      out.write("    .admin a:hover {\r\n");
      ...
      out.write("    <form action=\"MailServlet\" method=\"post\" id=\"Challenging\">\r\n");
      out.write("        to: <input type=\"text\" name=\"username\" id=\"Challenging_username\"> <br/>\r\n");
      out.write("        <label for=\"Challenging_quizzes\">\r\n");
      out.write("            choose a quiz:\r\n");
      out.write("        </label>\r\n");
      out.write("        <select name=\"quizzes\" id=\"Challenging_quizzes\">\r\n");
      out.write("            ");
      ...
      out.write("\r\n");
      out.write("        </select>\r\n");
      out.write("        <input class=\"button button7\" type=\"button\" name=\"button\" value=\"challenge\" id = \"Challenging_button\">\r\n");
      out.write("        <span  id=\"Challenging_output\"></span>\r\n");
      ...
      out.write("    <form action=\"MailServlet\" method=\"post\" id=\"FriendRequesting\">\r\n");
      out.write("        to: <input type=\"text\" name=\"username\" id=\"FriendRequesting_username\"> <br/>\r\n");
      out.write("        <input class=\"button button7\" type=\"button\" name=\"button\" value=\"sendRequest\" id=\"FriendRequesting_button\">\r\n");
      out.write("        <span id=\"FriendRequesting_output\"></span>\r\n");
      out.write("    </form>\r\n");
      ...
      out.write("    <form action=\"MailServlet\" method=\"post\" id=\"Composing\">\r\n");
      out.write("        to: <input type=\"text\" name=\"username\" id=\"Composing_username\"> <br/>\r\n");
      out.write("        message: <input type=\"text\" name=\"message\" id=\"Composing_message\"> <br/>\r\n");
      out.write("        <input class=\"button button7\" type=\"button\" name=\"button\" value=\"send\" id=\"Composing_button\">\r\n");
      out.write("        <span  id=\"Composing_output\"></span>\r\n");
      out.write("\r\n");
      out.write("    </form>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/UserPage.jsp(137,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
